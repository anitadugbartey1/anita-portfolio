      ...
      <div className="portfolio-content">
        ...
        <div className="education">
          ...
          <ul>
            <li>
              ...
              <p><strong>Coursework</strong>: CS 1200 (Intro to Algorithms), CS 20 (Intro to Discrete Math), CS 32 (Intro to Computer Programming 1), Stat 100 (Intro to R Programming), Applied Math 22A (Linear Algebra), CS 1070 (Systems Development for CS), MIT 15.501 (Accounting)</p>
            </li>
        ...
        <div className="skills">
          ...
          <ul>
            ...
            <li><strong>Tools:</strong> Postman, Git, Prisma, Render, Vercel, Microsoft Suite (Word, Access, Powerpoint,etc.), AWS Cloud (Certification in Progress)</li>
        ...
        <div className="awards">
          ...
          <ul>
            <li>
              <li><strong>Scholarships:</strong> Ron Brown Scholar, Dell Scholar,
Alpha Kappa Alpha (AKA) Tau Nu Omega Scholar, Blacks at Microsoft Scholar, Association of Blacks in Energy (AABE)
Scholar, David and Dovetta Wilson Scholar, UNCF Edna Blum Scholar, UNCF Pierre and Tana Matisse Foundation Scholar, New York Urban League Whitney M. Young Scholar, United Black Golfers Association Scholar</li>
              
            </li>
            <li>
            <li><strong>Honors:</strong> Harvard Club of New York Foundation Scholar, Kathlena Wilson Award, 2023 Harvard Club of New York Summer Fellow</li>
