  ...
  <div className="education">
    ...
    <ul>
      <li>
        ...
        <p><strong>Coursework</strong>: CS 1200 (Intro to Algorithms), CS 20 (Intro to Discrete Math), CS 32 (Intro to Computer Programming 1), Stat 100 (Intro to R Programming), CS 61 (Systems Programming and Machine Organization), MIT 15.501 (Accounting)</p>
      </li>
    </ul>
  </div>
);
